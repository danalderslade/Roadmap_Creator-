...
def build_template(output_path: Path) -> None:
    ...
    headers = ["application", "feature_name", "region", "month", "year", "delivery_type"]
    ...
    region_validation = DataValidation(type="list", formula1='"ASIA,MENA,EUROPE,UK,LATAM,US"', allow_blank=True)
    ...
    delivery_type_validation = DataValidation(
        type="list",
        formula1='"Feature,Run,New Market Deployment"',
        allow_blank=True,
    )
    ...
    sheet.add_data_validation(delivery_type_validation)

    region_validation.add("C2:C1000")
    month_validation.add("D2:D1000")
    year_validation.add("E2:E1000")
    delivery_type_validation.add("F2:F1000")

    sheet.freeze_panes = "A2"
    sheet.auto_filter.ref = "A1:F1000"
    ...
    help_sheet["A4"] = "Required columns: application, feature_name, region, month, year, delivery_type."
    help_sheet["A5"] = "Quarter is auto-generated by the application based on month + year."
    help_sheet["A6"] = "Region must be one of: ASIA, MENA, EUROPE, UK, LATAM, US."
    help_sheet["A7"] = "Use full month names (for example, January)."
    help_sheet["A8"] = "Use a 4-digit year (for example, 2026)."
    help_sheet["A9"] = "Delivery type must be one of: Feature, Run, New Market Deployment."
